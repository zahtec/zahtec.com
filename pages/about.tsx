    ...
    return (
        <>
            ...
            <main>
                ...
                <p className="load-anim mt-4">
                    I love building products that take <Underline color="text-red">every aspect</Underline> into account, when I build a website I make sure to have <Underline color="text-brown">every possible case handled</Underline>, burger menu still open when browser is resized? Element being overflowed when at an obscure height? Every <Underline color="text-blue">aspect</Underline> comes to account when I build a product giving it a <Underline color="text-green">polish</Underline> where finding bugs feels like more of a <Underline color="text-yellow">challenge</Underline> rather than easily being able to spam an input and find one.
                </p>
                <p className="load-anim mt-4">
